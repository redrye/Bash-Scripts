#!/bin/sh
#   02/24/2007. Removed the clear call.
#   06/27/2007. Added the urlclassifier2.sqlite file.
#   07/04/2007. Direct errors to /dev/null.
#   07/16/2007. Updated for OS X 10.4.10.
#   07/20/2007. Resolved an accidental issue.
#   08/21/2007. Added additional files to delete.
#                           Directing more errors to /dev/null.
#   02/20/2008. Changed SCRIPTS101_DIR to SHUTS_DIR.
#   09/07/2008. Changed urlclassifier2.sqlite to
#                           urlclassifier*.sqlite.
#   09/24/2008. Added more files.
#   10/08/2008. The wipe command is now supported.
#   10/24/2008. Changed sessionstore.js to sessionstore.*.
#   04/21/2009. Added search.json and secmod.db.
#   11/04/2010. Fixed empty answer.
#   04/27/2012. Added -q to wipe.
#   02/23/2014. Verify that files are readable.
